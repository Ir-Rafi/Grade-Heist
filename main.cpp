...
{    int uniqueCompleted = 0;
    ...
    std::vector<TaskDef> tasks = {
        ...
        { TaskType::servTask,   &servRects,     [&](){ servTask.start();      }, [&](){return lockerTask.isFinished();    } },
        { TaskType::Gradechg,   &gradechgRects, [&](){ gradeChanger.start();  }, [&](){return lockerTask.isFinished();    } },
